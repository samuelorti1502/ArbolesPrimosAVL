...
public class TextoDinamico extends Thread {
    int contador;
    ...
    public TextoDinamico(JLabel lblCadena, JLabel lblMensaje)
    {
    ...
    public TextoDinamico(String cadena, int sleep, JLabel lblCadena, JLabel lblMensaje) throws Exception
    {
        try
        {
            this.cadena = cadena;
    ...
    public void run()
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                Logger.getLogger(TextoDinamico.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
}
